...
# 起点：固定坐标 vs 追踪实体（device_tracker / person）
CONF_ORIGIN_MODE = "origin_mode"
CONF_ORIGIN_ENTITY = "origin_entity_id"

MODE_ORIGIN_STATIC = "static"
MODE_ORIGIN_DEVICE_TRACKER = "device_tracker"
...
ATTR_TOLLS = "tolls"
ATTR_ORIGIN_ENTITY = "origin_entity_id"
ATTR_ORIGIN_MODE = "origin_mode"
